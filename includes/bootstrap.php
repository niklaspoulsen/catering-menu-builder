...
require_once CMBWC_PATH . 'includes/admin-surcharges.php';
...
require_once CMBWC_PATH . 'includes/cart-order.php';
require_once CMBWC_PATH . 'includes/surcharges.php';
require_once CMBWC_PATH . 'includes/bon-printnode.php';
